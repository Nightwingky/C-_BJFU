...
namespace Tetris_NightwingQky
{
    class Block
    {
        ...
        private const int squareSize = GameField.SquareSize;//边长
        ...
        { //当blockType为undefined时，随机产生方块形状
            ...
            backColor = GameField.BackColor[i];
            Size squareS = new Size(squareSize, squareSize);
            square1 = new Square(squareS, backColor);
            square2 = new Square(squareS, backColor);
            square3 = new Square(squareS, backColor);
            square4 = new Square(squareS, backColor);
